...
### 步骤1: 打开Scratch3 Lab
推荐使用Chrome浏览器点击打开[Scratch3 Lab](https://scratch3-lab.just4fun.site/)，目前Scratch官方团队在目录支持更多浏览器版本，现阶段使用Chrome浏览器效果最佳
...
ps: Windows7用户注意(Mac和Windows10用户可以跳过),为了能发现并连接micro:bit，需要[安装驱动](../../img/mbedWinSerial_16466.exe)(和mu-editor相同)
