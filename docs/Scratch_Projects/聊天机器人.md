...
将以下代码保存到`eim_monitor.py`文件里(在[Adapter 插件目录](https://adapter.codelab.club/user_guide/FAQ/#_1)中)
...
[聊天机器人源码](https://scratch3v3.codelab.club/?sb3url=https://adapter.codelab.club/sb3/Scratch-tuling-chatbot.sb3)
